    ...
    - generic [ref=e92] [cursor=pointer]:
      ...
      - generic [ref=e97]:
        ...
        - button "Collapse issues badge" [ref=e104]:
          - img [ref=e105]
  - generic [ref=e108]:
    - 'heading "Application error: a server-side exception has occurred while loading localhost (see the server logs for more information)." [level=2] [ref=e109]'
    - paragraph [ref=e110]: "Digest: 1159220038"
```