...
We automatically collect data from you for example when you visit CandidAI.
...
We collect the data you give to us for example when you create an account on CandidAI.
...
**Service provided by:** Google LLC (United States) – [Privacy Policy](https://policies.google.com/privacy)
...
**Service provided by:** Vercel Inc. (United States) – [Privacy Policy](https://vercel.com/legal/privacy-policy)
...
**Personal Data processed:** Email address, password, social media accounts
...
This Application uses Trackers. To learn more, Users may consult the [Cookie Policy](/docs/cookie-policy).
