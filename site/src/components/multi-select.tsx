	...
	(
		...
		return (
			<>
				...
				<Popover
					open={isPopoverOpen}
					onOpenChange={o => {setIsPopoverOpen(o); if (!o) onClose(selectedValues)}}
					modal={modalPopover}>
										...
										{selectedValues
											...
											.map((value, i, self) => {
												...
												return (
                                                    ...
                                                    {badgeSeparator && i < self.length - 1 && <span className="text-violet-400 font-bold">{badgeSeparator}</span>}
                                                    </>
												);
											})
											.filter(Boolean)}
