                ...
                <div className="mb-8 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            ...
                            <li><Link href="/docs/terms-of-service" className="hover:text-white transition-colors">Terms of Service</Link></li>
                            <li><Link href="/docs/ambassador-program-terms" className="hover:text-white transition-colors">Ambassador Terms</Link></li>
                        </ul>
                    </div>
                </div>
